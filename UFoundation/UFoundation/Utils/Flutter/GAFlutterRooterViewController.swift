...
//
//class GAFlutterRooterViewController: FlutterViewController {
//
//    var channelMethodArguments: [String: Any] = ["navigate":["path":"ROCKET_GAME","data":["duration":30]]]
//
//    // 要与main.dart中一致
//    var channelName = "samples.flutter.dev/battery"
//
//    //单项管道，有可能使用多次
...
//        messageChannel.invokeMethod("navigate", arguments: ["token": CurrentUser.token ?? "token is null","data":["duration":30]])
//
//        //Flutter 传参数的回调
...
//        let channelName = "APP/Event/Channel";
